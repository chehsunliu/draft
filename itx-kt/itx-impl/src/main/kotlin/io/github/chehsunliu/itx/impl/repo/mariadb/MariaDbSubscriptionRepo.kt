...
internal class MariaDbSubscriptionRepo(
        ...
        ds.useConnection { conn ->
            conn
                .prepareStatement(
                    ...
                    it.bindAll(params.subscriberId.toString(), params.authorId.toString())
                    it.executeUpdate()
                }
        }
    }
        ...
        ds.useConnection { conn ->
            conn
                ...
                """,
                    ...
                    ps.bindAll(subscriberId.toString())
                    ps.executeQuery().use { rs ->
                        rs.mapAll { User(UUID.fromString(it.getString("id")), it.getString("email")) }
                    }
                }
        }
