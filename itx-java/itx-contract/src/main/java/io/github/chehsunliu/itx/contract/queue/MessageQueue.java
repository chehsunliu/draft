...
public interface MessageQueue {
    ...
    /**
     * Run the consumer loop, dispatching each message to {@code handler}. When {@code cancel} flips
     * to {@code true} the impl stops pulling new messages and waits for in-flight handlers to finish
